...
export const ingredients = [
  ...
  { label: "Chili Powder", value: "chili_powder" },
  ...
  { label: "Cocoa Powder", value: "cocoa_powder" },
  ...
  { label: "Hot Sauce", value: "hot_sauce" },
  { label: "Barbecue Sauce", value: "barbecue_sauce" },
  { label: "Worcestershire Sauce", value: "worcestershire_sauce" },
  { label: "Curry Powder", value: "curry_powder" },
  ...
  { label: "Bay Leaves", value: "bay_leaves" },
  ...
  { label: "Butternut Squash", value: "butternut_squash" },
  { label: "Acorn Squash", value: "acorn_squash" },
  { label: "Spaghetti Squash", value: "spaghetti_squash" },
  ...
  { label: "Snow Peas", value: "snow_peas" },
  { label: "Water Chestnut", value: "water_chestnut" },
  { label: "Bok Choy", value: "bok_choy" },
  { label: "Napa Cabbage", value: "napa_cabbage" },
  { label: "Collard Greens", value: "collard_greens" },
  { label: "Mustard Greens", value: "mustard_greens" },
  { label: "Swiss Chard", value: "swiss_chard" },
  { label: "Kohlrabi", value: "kohlrabi" },
  { label: "Arugula", value: "arugula" },
  { label: "Endive", value: "endive" },
  { label: "Escarole", value: "escarole" },
  { label: "Radicchio", value: "radicchio" },
  { label: "Bamboo Shoots", value: "bamboo_shoots" },
  { label: "Bean Sprouts", value: "bean_sprouts" },
  ...
  { label: "Natto", value: "natto" },
  { label: "Tahini", value: "tahini" },
  { label: "Sriracha", value: "sriracha" },
  { label: "Hoison Sauce", value: "hoison_sauce" },
  { label: "Oyster Sauce", value: "oyster_sauce" },
  { label: "Fish Sauce", value: "fish_sauce" },
  { label: "Tzatziki", value: "tzatziki" },
  { label: "Hummus", value: "hummus" },
  { label: "Baba Ganoush", value: "baba_ganoush" },
  { label: "Chutney", value: "chutney" },
  { label: "Pesto", value: "pesto" },
  { label: "Marinara Sauce", value: "marinara_sauce" },
  { label: "Alfredo Sauce", value: "alfredo_sauce" },
  { label: "Balsamic Glaze", value: "balsamic_glaze" },
  { label: "Cocktail Sauce", value: "cocktail_sauce" },
  { label: "Remoulade", value: "remoulade" },
