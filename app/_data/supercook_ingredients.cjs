...
//   let csv = "id,group_name,ingredient\n";
//   data.forEach((item) => {
//     const groupName = item.group_name;
//     item.ingredients.forEach((ingredient) => {
//       const id = uuidv4(); // Generate a unique ID for each row
//       csv += `"${id}","${groupName}","${ingredient}"\n`;
//     });
//   });
//   return csv;
// }
...
// fs.writeFile("ingredients.csv", csvContent, (err) => {
//   if (err) {
